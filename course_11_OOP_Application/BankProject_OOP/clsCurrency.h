...
enum enMode {eUpdateMode =1 , eEmptyMode = 0 };
enMode _Mode ;
...
static clsCurrency _ConvertLinetoCurrencyObject (string Line , string Separator = "#//#")
{
    ...
    {
     return clsCurrency(enMode::eUpdateMode , vCurrencyData[0] , vCurrencyData[1] ,
...
double ConvertToOtherCurrency (float Amount , clsCurrency Currency2 )
{
